...
const styles = StyleSheet.create({
  container: {
    ...
    padding: 16,
    backgroundColor: "#eaeaea", // Modern soft gray background
  },
  title: {
    fontSize: 30,
    fontWeight: "bold",
    color: "#4a4a4a", // Modern soft gray for text
    marginBottom: 20,
    textAlign: "center",
    letterSpacing: 0.5,
  },
  input: {
    backgroundColor: "#f7f7f7", // Lighter gray for input background
    color: "#4a4a4a", // Modern soft gray for text
    marginBottom: 15,
    borderRadius: 10,
    padding: 12,
  ...
  button: {
    backgroundColor: "#6c6c6c", // Button with modern soft gray tone
    borderRadius: 10,
    padding: 14,
    alignItems: "center",
    marginTop: 10,
  ...
  registerText: {
    color: "#7d7d7d", // Softer complementary gray
    fontWeight: "600",
    fontSize: 14,
  },
});
